...
export class DisplayLayoutTypeAMenu extends BaseMenuItem {
  constructor() {
    super({
      data: {
        title: "Type-A",
...
<rect x="2" y="2" width="9" height="20" rx="1" fill="#1E78BE"/>
<rect x="13" y="2" width="9" height="9" rx="1" fill="#1E78BE"/>
